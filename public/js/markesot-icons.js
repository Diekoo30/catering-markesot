...
const PAYMENT_ICONS = {
  info: `<circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><circle cx="12" cy="8" r="1" fill="currentColor" stroke="none"></circle>`,
  cash: `<rect x="2" y="6" width="20" height="12" rx="2.5"></rect><circle cx="12" cy="12" r="2.5"></circle><circle cx="6" cy="12" r="0.75" fill="currentColor" stroke="none"></circle><circle cx="18" cy="12" r="0.75" fill="currentColor" stroke="none"></circle>`,
  bank: `<path d="M3 21h18"></path><path d="M3 10h18"></path><path d="M5 6l7-3 7 3"></path><path d="M4 10v11"></path><path d="M20 10v11"></path><path d="M8 14v3"></path><path d="M12 14v3"></path><path d="M16 14v3"></path>`,
};
function paymentIcon(name){
  return '<svg class="payment-svg-icon" aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">' + PAYMENT_ICONS[name] + '</svg>';
}
...
function oS2(){
  ...
  <div class="pay-opts">
    <div class="pay-opt ${payMethod==='cash'?'sel':''}" onclick="selPay('cash')"><div class="pay-opt-icon">${paymentIcon('cash')}</div><div class="pay-opt-name">Tunai</div><div class="pay-opt-hint">Bayar saat pengambilan</div></div>
    <div class="pay-opt ${payMethod==='bank'?'sel':''}" onclick="selPay('bank')"><div class="pay-opt-icon">${paymentIcon('bank')}</div><div class="pay-opt-name">Transfer Bank</div><div class="pay-opt-hint">Rekening mengikuti pengaturan admin</div></div>
  </div>`;
...
function oS3(){
  ...
  return `<div class="success-wrap">
    <div class="success-ico"><span class="inline-icon" aria-hidden="true">OK</span></div>
